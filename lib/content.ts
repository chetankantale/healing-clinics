...
export const treatmentItems: TreatmentItem[] = [
  ...
  },
  {
    ...
    overview: 'Pigmentation treatment at Dermacare Elite blends clinical peels, laser therapy, and bespoke skincare to fade dark spots and harmonize skin tone.',
  ...
  },
  {
    ...
    summary: 'Natural-looking restoration using advanced hair transplant techniques and premium clinical support.',
    heroImage: 'https://images.unsplash.com/photo-1511424443515-9d6a1461f5d4?auto=format&fit=crop&w=900&q=80',
    overview: 'Our hair transplant services focus on careful graft placement, natural density, and personalized restoration plans for lasting confidence.',
    benefits: ['Restore hair density with natural results', 'Improve scalp health and coverage', 'Build a sustainable growth plan'],
    steps: ['Consultation and donor area evaluation', 'Precise graft extraction and implantation', 'Recovery guidance and growth monitoring'],
    results: 'A fuller, natural hairline with professional care through every step of the transplant journey.',
    faqs: [
      { question: 'How long does recovery take?', answer: 'Most clients return to normal activity within a week, with final hair growth visible in 6 to 12 months.' },
      { question: 'Will my hair look natural?', answer: 'Yes. Our approach emphasizes natural direction, density and hairline design for discreet restoration.' },
      { question: 'Is the procedure comfortable?', answer: 'Local anesthesia and comfort-focused care help keep the procedure as comfortable as possible.' }
    ]
  },
  {
    slug: 'prp-therapy',
  ...
  },
  {
    ...
    overview: 'Laser hair removal at Dermacare Elite delivers precise, safe reduction of unwanted hair with advanced energy systems and expert skin assessment.',
  ...
  },
  {
    ...
    overview: 'Chemical peels at Dermacare Elite target dullness, uneven tone, and surface imperfections with medical-grade formulations and personalized depth control.',
